    ...
    gsap.to(loaderWrapper, {
      ...
      onComplete: () => {
        ...
        if (preloaderDiv && preloaderWord) {
          ...
          gsap.fromTo(preloaderText, { opacity: 0 }, { opacity: 0.75, duration: 1, ease: "power2.out" });
          ...
          function startExitAnimation() {
            ...
            gsap.to(overlay, { top: "-100vh", duration: 0.8, ease: "power4.inOut", delay: 0.2 });
            
            // Slide up text
            gsap.to(preloaderText, { top: "-10vh", opacity: 0, duration: 0.8, ease: "power4.inOut" });
